        ...
        execute_cmd() {
            if (this.do_input) {
                ...
                if (this.cmd == 'help') {
                    ...
                    for (let key in _this.example_names) {
                        this.terminal.writeln(key + ': ' + _this.example_names[key]);
                    }
                    this.terminal.write(this.prefix);
                }
                    ...
                    console.log(number);
                    if (number in _this.example_code) {
                        this.editor.setValue(_this.example_code[number]);
                    }
                    this.terminal.write(this.prefix);
                }
                else {
